        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Item1Icon = table.Column<string>(type: "TEXT", nullable: false),
                    Item2 = table.Column<string>(type: "TEXT", nullable: false),
                    Item2Icon = table.Column<string>(type: "TEXT", nullable: false),
                    Item3 = table.Column<string>(type: "TEXT", nullable: false),
                    Item3Icon = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
